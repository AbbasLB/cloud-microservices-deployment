...
type LogServiceClient interface {
	AddLog(ctx context.Context, in *AddLogRequest, opts ...grpc.CallOption) (*Empty, error)
	GetLog(ctx context.Context, in *GetLogRequest, opts ...grpc.CallOption) (*Empty, error)
}
...
func (c *logServiceClient) AddLog(ctx context.Context, in *AddLogRequest, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, "/hipstershop.LogService/AddLog", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *logServiceClient) GetLog(ctx context.Context, in *GetLogRequest, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, "/hipstershop.LogService/GetLog", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type LogServiceServer interface {
	AddLog(context.Context, *AddLogRequest) (*Empty, error)
	GetLog(context.Context, *GetLogRequest) (*Empty, error)
...
func (UnimplementedLogServiceServer) AddLog(context.Context, *AddLogRequest) (*Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AddLog not implemented")
}
func (UnimplementedLogServiceServer) GetLog(context.Context, *GetLogRequest) (*Empty, error) {
...
func _LogService_AddLog_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hipstershop.LogService/AddLog",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _LogService_GetLog_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hipstershop.LogService/GetLog",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var LogService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "hipstershop.LogService",
